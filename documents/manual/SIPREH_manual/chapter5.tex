...
\paragraph{Cálculo de la anomalía de precipitación:}Para este proceso se utiliza el SPI, que mide cuántas desviaciones estándar se aparta la precipitación de su valor normal. Para devolverlo a milímetros, SIPREH lo multiplica por la \textbf{desviación estándar histórica} de la precipitación acumulada de la celda:
\[
...
\paragraph{Construcción de la normal climatológica:}La referencia $\sigma^{P}_{c}$ se construye siempre a partir de la precipitación observada de \textbf{CHIRPS}, con estos pasos por celda:
...
\subsubsection{Convención de nombre de archivo}
...
\subsubsection{Pasos para cargar un nuevo archivo}
...
\subsubsection{Actualización de un archivo existente}
