...
\begin{itemize}
    ...
    \item Realizar la sincronización de los conjuntos de datos y la configuración de la fecha de emisión de los productos de predicción, utilizada como referencia para la identificación de los horizontes de predicción y para el cálculo de la precipitación media de la normal climatológica y la anomalía de precipitación asociadas a las predicciones.
